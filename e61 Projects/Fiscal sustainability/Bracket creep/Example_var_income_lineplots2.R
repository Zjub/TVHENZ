...
# -----------------------------
tax_function <- function(income, include_levy = levy, include_surcharge = surcharge) {
...
save_e61("2 Overall effective tax rate by income_LITO.png",res=2)
...
save_e61("ETR_comparison_regularity_CGT_LITO.png",res=2)
