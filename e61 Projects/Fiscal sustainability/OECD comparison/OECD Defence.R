...
ggplot(Aus_toGDP[COFOG_Area == "Defence"],aes(x=as.numeric(Year)+1997, y=value*100,fill = as.factor(Government_level))) + 
  geom_col() +
  theme_e61(legend = "bottom") + labs_e61(title = "Defence ",y="% GDP") +
