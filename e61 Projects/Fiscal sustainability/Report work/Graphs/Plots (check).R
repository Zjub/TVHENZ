...
# This version turns off the plot sharing, so we can check for package update issues without deleting graphs.
...
#save_e61("Figure_5.png",p5a,p5b,res=2,sources = c("e61","OECD"), title = "Consolidated Expenditure", footnotes = c("Spending shares based on OECD standard consolidation.","FY has been shifted forward by one relative to OECD reporting - due to the Australian financial year starting six months later than other countries."))
#save_e61("Report_graph/Figure_5.svg",p5a,p5b,sources = c("e61","OECD"), title = "Consolidated Expenditure",footnotes = c("Spending shares based on OECD standard consolidation.","FY has been shifted forward by one relative to OECD reporting - due to the Australian financial year starting six months later than other countries."))
...
#save_e61("Figure_8.png",p8a,p8b,res=2,sources = c("e61","OECD"), title = "Cross-country comparison (2022)",footnotes = c("Dark blue is spending by Federal Govt % GDP. Light blue is additional spending attributed to non-Federal entities.","FY has been shifted forward by one relative to OECD reporting - due to the Australian financial year starting six months later than other countries."))
#save_e61("Report_graph/Figure_8.svg",p8a,p8b,sources = c("e61","OECD"), title = "Consolidated Expenditure",footnotes = c("Dark blue is spending by Federal Govt % GDP. Light blue is additional spending attributed to non-Federal entities.","FY has been shifted forward by one relative to OECD reporting - due to the Australian financial year starting six months later than other countries."))
...
#save_e61("Report_graph/new_Figure_8.svg",p8a_new,p8b_new,sources = c("e61","OECD"), title = "International consolidated accounts",footnotes = c("Dark blue is spending by Federal Govt % GDP. Light blue is additional spending attributed to non-Federal entities.","FY has been shifted forward by one relative to OECD reporting - due to the Australian financial year starting six months later than other countries."))
...
#save_e61("Short_Figure_6.png",plot_36,plot_37a2,res=2,title ="Social Protection Expenditure", sources = c("ABS", "e61"),footnotes = c("In-Kind includes Social benefits to households in goods and services, and Use of goods and services.","Other reflects the costs of administration."))

#save_e61("Report_graph/Short_Figure_6.svg",plot_36,plot_37a2,res=2,title ="Social Protection Expenditure",sources = c("ABS", "e61"),footnotes = c("In-Kind includes Social benefits to households in goods and services, and Use of goods and services.","Other reflects the costs of administration."))
