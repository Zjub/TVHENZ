...
nyT         = 5; %transitory component (not a state variable, but used for expectations)
sd_logyT   = 0.20; %0.20; %relevant if nyT>1
...
%government
labtaxlow       = 0.90; %proportional tax
labtaxhigh      = 0; %additional tax on incomes above threshold
labtaxthreshpc   = 0.999; %percentile of earnings distribution where high tax rate kicks in
