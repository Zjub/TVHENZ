...
save_e61("JFR_level_diff.png",res=2,pad_width = 1,auto_scale = FALSE)
...
save_e61("JFR_level_diff.pdf",res=2,pad_width = 1,auto_scale = FALSE)
...
save_e61("JFR_level_diff2.png",res=2,pad_width = 1,auto_scale = FALSE)
...
save_e61("JFR_level_diff2.pdf",res=2,pad_width = 1,auto_scale = FALSE)
