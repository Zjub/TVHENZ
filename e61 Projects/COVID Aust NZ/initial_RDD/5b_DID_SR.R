...
save_e61("SR_level_diffnoJSP.png",res=2,pad_width = 1,auto_scale = FALSE)
...
save_e61("SR_level_diffnoJSP.pdf",res=2,pad_width = 1,auto_scale = FALSE)
...
prop_JSP_matched_dt2 <- read.csv("SR_noJSP_by_group 2 .csv")  # Main results JSP
...
save_e61("SR_level_diff2noJSP.png",res=2,pad_width = 1,auto_scale = FALSE)
