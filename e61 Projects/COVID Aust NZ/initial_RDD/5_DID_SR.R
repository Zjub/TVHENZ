...
if (treatment_number == 1){
  prop_JSP_matched_dt <- read.csv("initial_RDD/SR_by_group 1 .csv")  # Main results JSP
  ...
  prop_JSP_matched_dt <- read.csv("initial_RDD/SR_by_group 2 .csv")  # Main results JSP
  setDT(prop_JSP_matched_dt)
...
prop_JSP_matched_dt2 <- read.csv("initial_RDD/SR_by_group 2 .csv")  # Main results JSP
