...
endmonth <- 10 ## Note "10" refers to last month of data, so needs to be updated
...
Source: ABS, e61.",
  )  + theme_e61(base_family = "Quattrocento Sans", legend = "bottom") + scale_x_continuous(breaks = unique(EEtrandf$Month)) + scale_y_continuous(limits=c(0.03,0.05),labels=scales::percent_format(scale=100,suffix="%",sec.axis = dup_axis())) + e61_colour_manual(n=2)
...
#   caption = "ABS Labour Force Survey Gross Monthly Flows.
# Source: ABS, e61.",
# )  + theme_e61(base_family = "Quattrocento Sans", legend = "bottom") + scale_x_continuous(breaks = unique(UEtrandf$month)) + scale_y_continuous(labels=scales::percent_format(scale=100,suffix="%",sec.axis = dup_axis())) + e61_colour_manual(n=3)
...
EFTO <- ggplot(EFTOtrandf %>% filter(Year != 2021),aes(x=Month,y=Transition,colour=Year)) + geom_line() + geom_vline(xintercept = 4,colour="red",linetype = "dashed") + geom_vline(xintercept = 9,colour="blue",linetype = "dashed") + labs(
  ...
  caption = "ABS Labour Force Survey Gross Monthly Flows.
Source: ABS, e61.",
)  + theme_e61(base_family = "Quattrocento Sans", legend = "bottom") + scale_x_continuous(breaks = unique(EUtrandf$Month)) + scale_y_continuous(limits = c(0.04,0.08),labels=scales::percent_format(scale=100,suffix="%",sec.axis = dup_axis())) + e61_colour_manual(n=2)
...
EU <- ggplot(EUtrandf %>% filter(Year != 2021),aes(x=Month,y=Transition,colour=Year)) + geom_line() + geom_vline(xintercept = 4,colour="red",linetype = "dashed") + geom_vline(xintercept = 9,colour="blue",linetype = "dashed") + labs(
  ...
  caption = "ABS Labour Force Survey Gross Monthly Flows.
Source: ABS, e61.",
)  + theme_e61(base_family = "Quattrocento Sans", legend = "bottom") + scale_x_continuous(breaks = unique(EUtrandf$Month)) + scale_y_continuous(limits = c(0.005,0.02),labels=scales::percent_format(scale=100,suffix="%",sec.axis = dup_axis())) + e61_colour_manual(n=2)
...
UE <- ggplot(UEtrandf %>% filter(Year != 2021),aes(x=Month,y=Transition,colour=Year)) + geom_line() + geom_vline(xintercept = 4,colour="red",linetype = "dashed") + geom_vline(xintercept = 9,colour="blue",linetype = "dashed") + labs(
  ...
  caption = "ABS Labour Force Survey Gross Monthly Flows.
Source: ABS, e61.",
)  + theme_e61(base_family = "Quattrocento Sans", legend = "bottom") + scale_x_continuous_e61(breaks = unique(UEtrandf$Month)) + scale_y_continuous_e61(limits=c(0.08,0.26),labels=scales::percent_format(scale=100,suffix="%",sec.axis = dup_axis())) + e61_colour_manual(n=2) 
...
e61_save(filename = 'C:/MN personal planning/Income_Support/plots/U2E.svg')
