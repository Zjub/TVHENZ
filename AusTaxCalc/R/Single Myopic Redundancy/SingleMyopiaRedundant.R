...
output <- calculate_lifetime_spend_myopia_shocks(initial_labour_earnings = 40000,interest_rate = 0.02,labour_start_year = 20,wage_growth = 0.02,youth_wageg = 0,old_wageg = 0,cite="youtube.com/@tvhe",death_year = 90,retirement_year = 67,superwithdraw = TRUE)
