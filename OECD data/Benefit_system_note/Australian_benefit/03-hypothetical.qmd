...
The Australian social security system was based on a similar principle to systems implemented in the United Kingdom and New Zealand through the 1930s and 1940s. Following the 1942 Beveridge Report's indication for the need for cradle to the grave **social insurance** to prevent hardship and encourage participation following World War II, Australia introduced the Social Security Act 1947.
...
In this way, the definition of income used to assess eligibility distinguishes itself from a purely flow income concept (i.e. Haig-Simons income - of the concept of potential income without lowering a stock of assets), as the stock of assets an individual has allows them to satisfy these needs.
...
Within this context, social policy settings that are focused on this **minimum standard** will apply rules about assets and family structure which reflect these views.
